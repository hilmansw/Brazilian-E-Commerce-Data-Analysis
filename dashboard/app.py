...
st.title('**📊Dashboard**')
st.subheader('Evaluasi Performa Penjualan 2016-2018')
...
ax.set_title("Total Order per Bulan (2016-2018)", loc="center", fontsize=14)
ax.tick_params(axis='y', labelsize=12)
ax.tick_params(axis='x', labelsize=12, rotation=45)
st.pyplot(fig)

# Plot Total Revenue per Bulan
fig, ax = plt.subplots(figsize=(10, 5))
ax.plot(
    monthly_orders_df["order_purchase_timestamp"],
...
ax.set_title("Total Revenue per Bulan (2016-2018)", loc="center", fontsize=14)
ax.tick_params(axis='y', labelsize=12)
ax.tick_params(axis='x', labelsize=12, rotation=45)
st.pyplot(fig)
...
# Plot produk yang paling banyak diminati
...
ax.set_title("Demografi Pelanggan Berdasarkan Negara", loc="center", fontsize=14)
ax.set_ylabel(None)
ax.set_xlabel(None)
ax.tick_params(axis='y', labelsize=12)
st.pyplot(fig)

# Plot 10 kota dengan pelanggan paling banyak
fig, ax = plt.subplots(figsize=(10, 5))
sns.barplot(
    x="customer_count",
    y="customer_city",
...
ax.set_title("10 Kota dengan Pelanggan Paling Banyak", loc="center", fontsize=16)
ax.set_ylabel(None)
ax.set_xlabel(None)
ax.tick_params(axis='y', labelsize=12)
st.pyplot(fig)

# Plot 10 kota dengan pelanggan paling sedikit
fig, ax = plt.subplots(figsize=(10, 5))
sns.barplot(
    x="customer_count",
    y="customer_city",
...
ax.set_title("Demografi Penjual Berdasarkan Negara", loc="center", fontsize=14)
ax.set_ylabel(None)
ax.set_xlabel(None)
ax.tick_params(axis='y', labelsize=12)
st.pyplot(fig)

# Plot 10 kota dengan penjual paling banyak
fig, ax = plt.subplots(figsize=(10, 5))
sns.barplot(
    x="seller_count",
    y="seller_city",
...
ax.set_title("10 Kota dengan Penjual Paling Banyak", loc="center", fontsize=16)
ax.set_ylabel(None)
ax.set_xlabel(None)
ax.tick_params(axis='y', labelsize=12)
st.pyplot(fig)

# Plot 10 kota dengan penjual paling sedikit
fig, ax = plt.subplots(figsize=(10, 5))
sns.barplot(
    x="seller_count",
    y="seller_city",
